...
3. 学习UiPath文档
### Tuesday
1. 工资日的Double开心，指导帮助市场部门使用RPA，收到了来说市场部门的蝴蝶感谢信。
2. rainbond服务器的8080访问SVN已开通，但是仍无法从SVN上部署应用。尝试在rainbond服务器安装SVN，并且主动checkout应用，连接依然失败，故申请开通3690端口的访问，希望可以解决问题。
3. LPS的case处理，用户提交的审批申请被吞，后台删除后重新申请;供应商看不到订单，已重新生成供应商订单。
4. 看uipath文档


## week15（19.11.4~19.11.8）
### Monday


## week16（19.11.11~19.11.15）
### Monday
